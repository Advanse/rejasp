...
public class SelectionClassesPage extends WizardPage implements Listener {
	...
	public void createControl(Composite parent) {
		...
		btnIndicationTypes.setText("Show only classes and interfaces that contains fields with indication");
	...
	private void buildTypeTree( boolean bOnlyIndication ) {
		...
		for ( int i = 0; i < lstTypeInfo.size(); i++ ) {
			...
			if ( ! bOnlyIndication || (element.getIndication() && element.indicationFieldExist() )  ) {
	...
	public IWizardPage getNextPage() {
		...
		wizard.selectionFieldsPage.onEnterPage();
		return wizard.selectionFieldsPage; 
	}
	...
	public void onEnterPage() {
		setDescription("Select classes and interfaces that contain fields to be moved to aspects");
